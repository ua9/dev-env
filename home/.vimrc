...
command -nargs=0 -bar UpdateS if &modified 
                           \|    if empty(bufname('%'))
                           ...
                           \|    endif
                           \|endif
nnoremap <silent> <C-S> :<C-u>UpdateS<CR>
inoremap <c-s> <c-o>:UpdateS<CR>
...
function! DisableRelativeNumbersMy()
  let g:relativemode = 0
  set number
  set norelativenumber
endfunc
au VimEnter * call DisableRelativeNumbersMy()
